          ...
          {step === "form" && (
            <div className="p-5 space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-gray-900">
                      {product.size}{" "}
                      {product.product_type === "data_bundle"
                        ? "Data Bundle"
                        : "Result Checker"}
                    </p>
                    <p className="text-sm text-gray-500">
              ...
              <p className="text-xs text-center text-gray-400">
                🔒 Secure checkout via Mobile Money. You'll receive a prompt on
                your phone.
              </p>
            </div>
          )}
            ...
            <div className="p-8 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  ...
                  <strong>{paymentNumber}</strong>. Please approve it now.
                </p>
              </div>
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
                <p className="text-xs text-amber-700 font-medium">
                  ⚠️ Do not close this page. Processing may take up to 60
                  seconds.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div className="bg-sky-50 rounded-xl p-4 text-left space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-sky-600">
                    {formatCurrency(orderResult.amount)}
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-xl p-3">
                ...
                <p className="text-xs text-green-700">
                  Your data will be delivered within minutes. Save your order
                  number.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={() =>
                    (window.location.href = `/track-order?id=${orderResult.order_number}`)
                  }
