...
const features = [
  {
    ...
    desc: "Data delivered to your phone in minutes after payment.",
  },
  {
    icon: Shield,
    title: "Secure Payments",
    desc: "All transactions secured via mobile money (MoMo).",
  },
  {
    icon: Clock,
    title: "24/7 Service",
    desc: "Buy anytime, anywhere. We never sleep.",
  },
  {
    icon: Star,
    title: "Best Prices",
    desc: "We guarantee the lowest prices for data in Ghana.",
  },
];
...
const testimonials = [
  {
    name: "Kwame A.",
    text: "Fastest data delivery in Ghana. I always buy my MTN bundles here.",
    stars: 5,
  },
  {
    name: "Ama S.",
    text: "Great prices and super easy to use. Got my AirtelTigo data in seconds!",
    stars: 5,
  },
  {
    name: "Kofi M.",
    text: "My BECE checker PIN came immediately. Will use again.",
    stars: 5,
  },
];
...
const steps = [
  {
    ...
    desc: "Select MTN, AirtelTigo, or Telecel",
  },
  {
    step: "2",
    title: "Pick a Package",
    desc: "Choose your preferred data size & price",
  },
  {
    step: "3",
    title: "Pay with MoMo",
  ...
  },
  {
    ...
    desc: "Data is sent directly to your number",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-sky-100 mb-8 text-balance">
              MTN, AirtelTigo & Telecel data bundles starting from{" "}
              <strong className="text-white">GHS 4.20</strong>. Instant delivery
              via Mobile Money.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        >
          ...
          <p className="text-gray-500 mt-2">
            Pick your preferred network and get the best deal
          </p>
        </motion.div>
          ...
          {networkCards.map((card, i) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`flex items-center gap-1 mt-3 text-xs font-semibold ${card.textColor} opacity-90 group-hover:gap-2 transition-all`}
                >
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Our most purchased data packages
            </p>
          </div>
          <Link
            to="/mtn-data"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="gradient-brand rounded-2xl p-8 sm:p-12 text-center text-white">
          ...
          <p className="text-sky-100 mb-6">
            Join thousands of Ghanaians buying cheap data on NetGH
          </p>
          <Link
            to="/mtn-data"
